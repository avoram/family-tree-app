...
| # | Milestone | Outcome |
|---|-----------|---------|
| 1 | Project scaffold + Auth | Monorepo scaffold (`frontend/` + `backend/`); Vercel-ready frontend; Express API shell; SuperAdmin/User login; role-based routing; seed accounts |
